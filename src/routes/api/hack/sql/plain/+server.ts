...
=======================
This endpoint is locked away in a secure facility, 
guarded by the same people who protect the Ark of the Covenant.
=======================
`;

export const POST: RequestHandler = async ({ request }) => {
    if (!dev) {
        return new Response(PROD_ERROR_ASCII, { 
